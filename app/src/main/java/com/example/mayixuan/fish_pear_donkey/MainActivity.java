...
import com.example.mayixuan.fish_pear_donkey.Database.Dao;
...
public class MainActivity extends AppCompatActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    Dao query=new Dao(this);
    Dao queryname=new Dao(this);
    Dao delete=new Dao(this);
    Dao insert=new Dao(this);
    Dao querycontent=new Dao(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //newInstance方法传参
        contentFragment = ContentFragment.newInstance(R.drawable.back);
...
//（3）将其添加到存放按钮视图的列表中。调用 AnimatorListener 接口的addViewToContainer(viewMenu)方法（我们要在 Activity 中人为的将其添加到界面布局中）。在菜单打开动画未完成情况下，将其属性设为不可用。调用animateView（）方法使用 FlipAnimation 类来实现动画设置，Handler 实现延时播放。
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_settings3:
                ...
                final LinearLayout ll=(LinearLayout) LayoutInflater.from(MainActivity.this).inflate( R.layout.newcontract,null );
            ...
            public void onClick(View view) {
                ...
                if(name.length()==0) {
                    Toast.makeText(MainActivity.this,"合同名不能为空。",Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private ScreenShotable replaceFragment(ScreenShotable screenShotable, int topPosition) {
        this.res = this.res == R.drawable.back ? R.drawable.back : R.drawable.back;
...
//                    @Override
//                    public void onClick(View view) {
//                        Toast.makeText(MainActivity.this,"bu成功",Toast.LENGTH_SHORT).show();
//                    }
//                } );
//
//            }
    ...
    private void button_click(TextView stvw){
        ...
        storeButton.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dao deleteold=new Dao(MainActivity.this);
                deleteold.delete( view_name.getText().toString());
                Dao addnew=new Dao(MainActivity.this);
        ...
        switch (slideMenuItem.getName()) {
            ...
            case "Building":
                ...
                for (int j=0;j<lineartest.getChildCount();j++){
                    ...
                    swipeLayout1.findViewById(R.id.deletebtn).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
